...
from utils.image_packer.image_packer import ImagePacker
...
class ImagePackerUI(QMainWindow):
    ...
    def __init__(self):
        ...
        label.setFixedWidth(ImagePacker.LABEL_WIDTH)
        self.edit_source = QLineEdit()
        self.btn_get_source = QPushButton("Get Source Folder")
        self.btn_get_source.setFixedWidth(ImagePacker.BUTTON_WIDTH)
        ...
        self.btn_get_target.setFixedWidth(ImagePacker.BUTTON_WIDTH)
        horizontal_container.addWidget(label)
        ...
        self.edit_cols.setFixedWidth(ImagePacker.LABEL_WIDTH)
        ...
        self.edit_rows.setFixedWidth(ImagePacker.LABEL_WIDTH)
        spacer = QSpacerItem(40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
        horizontal_container.addWidget(label)
        ...
        self.btn_pack.setFixedWidth(ImagePacker.BUTTON_WIDTH)
        horizontal_container.addItem(spacer)
